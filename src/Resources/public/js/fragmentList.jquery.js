(function($) {
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            var divElement = $('<div>');
            divElement.attr('id', 'deletedFragments');
        ...
        remove: function(e) {
            ...
            if (!$frag.hasClass('is-tmp')) {
                // Hide form block
                $form.hide();
                this.moveSelectedFragmentElements(id, $frag, $form);
        ...
        /**
         * This method move the selected fragment and from elements in div#deletedFragments
         *
         * @param id
         * @param fragmentElement
         * @param formElement
         */
        moveSelectedFragmentElements: function (id, fragmentElement, formElement) {
            var divElement = this.getFirstElement($('<div>'));
            divElement.setAttribute('id', id);
            fragmentElement.clone().appendTo(divElement);
            divElement.append(this.getFirstElement(formElement));
            ...
            // Insert the title of fragment and the reset button at the pace of removed fragment.
            fragmentElement.empty();
            fragmentElement.append(resetRemovedElement);

            // Insert the selected fragment and form into #deletedFragments.
            this.getFirstElement($('#deletedFragments')).append(divElement);
        },

        /**
         * This method cancel the fragment deletion.
         *
         * @param e
         */
        cancelFragmentdeletion: function (e) {
            ...
            var canceledFragment = $('div#deletedFragments');
        ...
        /**
         * This element return the first item from the list.
         *
         * @param elements
         */
        getFirstElement: function(elements) {
            return elements[0];
        },
